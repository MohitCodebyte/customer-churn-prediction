...
if predict_clicked:
    ...
    sample[0][0]  = gender_val;        sample[0][1]  = senior
    sample[0][2]  = partner;           sample[0][3]  = dependents
    sample[0][4]  = tenure;            sample[0][5]  = phone_service
    sample[0][6]  = paperless;         sample[0][7]  = monthly
    sample[0][8]  = total;             sample[0][9]  = multiple_lines
    sample[0][10] = internet_fiber;    sample[0][11] = internet_no
    sample[0][12] = online_security;   sample[0][13] = online_backup
    sample[0][14] = device_protection; sample[0][15] = tech_support
    sample[0][16] = streaming_tv;      sample[0][17] = streaming_movies
    sample[0][18] = contract_one;      sample[0][19] = contract_two
    sample[0][20] = payment_credit;    sample[0][21] = payment_electronic
